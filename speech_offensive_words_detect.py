# -*- coding: utf-8 -*-
"""speech offensive words detect.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1GfVIixXqX9UDBWnbDyKqqpr9-Myweuy6
"""

# List of offensive words
offensive_words = ["hate", "inyenzi", "cockroaches", "kill", "exterminate", "destroy",
    "traitors", "snakes", "Hutus","rats", "hutu power", "tutsi",
    "ethnic cleansing", "wipe out", "enemy", "revenge",
    "impurity", "traitors", "infiltrators", "parasites", "racist", "sexist", "attack", "violence"]
